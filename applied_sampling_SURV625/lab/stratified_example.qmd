...
## Calculating point estimates with poststratification
...
```{r}
p_hat_females <- 84/n_female ; p_hat_females
p_hat_males <- 40/n_male ; p_hat_males
...
# We propose that the population estimate from our sample to be 945 (SE=.029, \[95% CI: 789, 1,101\]) female and 325 (SE=.032, \[95% CI: 243, 407\]) male students are planign to pursue academic careers.

\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ Test \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_

### I don't understand how we can use the known populations 2,700 for females, and 1,300 for males, unless we use poststratified p_hats as below, but these would give us smaller numbers in the end. 

```{r}
p_hat_females_post <- p_hat_females * (N_female / N) ; p_hat_females_post
p_hat_males_post <- p_hat_males * (N_male / N) ; p_hat_males_post
```
