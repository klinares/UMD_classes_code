...
my.list <- list(1:4, c("Ruben", "Amy", "Rebecca", "Kevin"), c(TRUE, FALSE, FALSE, TRUE)) |> 
  set_names(c("int", "name", "log_vec"))
str(my.list)

# append a new element in between list elements from original list
new_list <- append(my.list.2, my.list, after=2)
